...
},{"../pages/search-page/js/list":"WSIo"}],"Llc0":[function(require,module,exports) {
"use strict";
...
},{}],"eCLt":[function(require,module,exports) {
module.exports = "loader.49ca52d9.svg";
},{}],"f62L":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loaderHTML = void 0;
var _loader = _interopRequireDefault(require("../assets/loader.svg"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
var loaderHTML = exports.loaderHTML = "<img class=\"centered\" id=\"loader\" width=\"150px\" height=\"150px\" src=\"".concat(_loader.default, "\" />");
},{"../assets/loader.svg":"eCLt"}],"WuOw":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _fakeAPI = require("../../../js/fakeAPI.js");
var _localStorage = _interopRequireDefault(require("../../destinations-page/js/localStorage.js"));
...
var PageLoading = /*#__PURE__*/function () {
  function PageLoading() {
    ...
    this.dateInput.setAttribute('placeholder', "".concat(new Date().toLocaleDateString('ru-RU')));
    ...
    this.tripsField.innerHTML = _loader.loaderHTML;
    this.regionInput.oninput = function () {
      _this.searching();
    };
    this.countryInput.oninput = function () {
      _this.searching();
    };
    this.resetBtn.addEventListener('click', function () {
      if (_this.regionInput.value || _this.countryInput.value) {
        _this.searching();
        _this.regionInput.value = '';
        _this.countryInput.value = '';
      }
    });
    this.emptyFieldsSearching();
    this.regionInput.value = _localStorage.default.getRegionName() ? _localStorage.default.getRegionName() : '';
    _localStorage.default.setRegionName('');
  }
  return _createClass(PageLoading, [{
    key: "searching",
    value: function searching() {
      this.tripsField.innerHTML = _loader.loaderHTML;
      (0, _list.errorImage)('none');
      (0, _fakeAPI.getMatchedData)();
    }
  }, {
    key: "emptyFieldsSearching",
    value: function emptyFieldsSearching() {
...
},{"../../../js/fakeAPI.js":"SCn8","../../destinations-page/js/localStorage.js":"Llc0","./list.js":"WSIo","./loader":"f62L"}],"wexD":[function(require,module,exports) {
"use strict";

var _PageLoading = _interopRequireDefault(require("./PageLoading.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
document.addEventListener('DOMContentLoaded', function () {
  var pageLoading = new _PageLoading.default();
});
},{"./PageLoading.js":"WuOw"}]},{},["wexD"], null)
//# sourceMappingURL=app.18dd2e83.js.map