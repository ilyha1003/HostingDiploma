...
},{}],"Qcng":[function(require,module,exports) {
"use strict";

var _fakeAPI = require("../../../js/fakeAPI");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var listElements = document.querySelectorAll('.places-list__item');
  listElements.forEach(function (el) {
    el.addEventListener('click', function () {
      var regionName = el.querySelector('.places-name').innerHTML;
      _localStorage.default.setRegionName(regionName);
    });
  });
});
},{"../../../js/fakeAPI":"SCn8","./localStorage":"Llc0"}]},{},["Qcng"], null)
//# sourceMappingURL=app.66f671ef.js.map